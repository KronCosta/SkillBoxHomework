...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        jsonWriter.writeInJSONFile(metro.getMetroObject(), "src/main/resources/map.json");

        JSONReader jsonReader = new JSONReader();
        jsonReader.getNumberOfStations("src/main/resources/map.json");
        jsonReader.getNumberOfConnections("src/main/resources/map.json");
    }
}